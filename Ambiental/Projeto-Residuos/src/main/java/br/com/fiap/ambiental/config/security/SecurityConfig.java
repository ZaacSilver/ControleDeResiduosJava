package br.com.fiap.ambiental.config.security;
...
//aqui ditamos as regras de acesso a API com SPRING SECURITY
@Configuration
@EnableWebSecurity
public class SecurityConfig { //Cadeia de Filtros Spring Security JWT
